...
RUN echo -e "192.168.2.172\tmongo_rs_0" >> /etc/hosts && \
    echo -e "172.16.238.2\tmongo_rs_1" >> /etc/hosts && \
    echo -e "172.16.238.3\tmongo_rs_arb_1" >> /etc/hosts && \
    echo -e "192.168.2.175\tmongo_rs_1 mongo_rs_arb_1" >> /etc/hosts && \
